...
public class UserInput {
     ...
     * @return user input
    */
    private String inputString (String userInfo, String errorInfo){
    ...
    */
     ...
     * @return user input
     */
    private int inputInteger (String userInfo, String errorInfo){
     ...
     * @param max: Max value user can enter
     * @return user input
     */
     ...
     * @return user input
    */
    private int lengthConstrainedInputInteger (String userInfo, String errorInfo, int length)
    {
        int userInput= inputInteger(userInfo, errorInfo);
